/*
8 - Implemente uma função chamada countBooksInCategory que conte o
...
function countBooksInCategory() {
    ...
    booksByCategory.forEach((categoriaObj) => {
        let nome = categoriaObj.category;
        let cont = categoriaObj.books.length;
